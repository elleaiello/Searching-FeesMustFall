...
#this is to get coords, text and media URL used IF they geotagged (w coords) and IF they posted media 
...
with open('stream_feesmustfall_part2.json', 'r') as f: #did this for stream_feesmustfall_part?.json, ? = part 1 and 2
    ...
    for line in f:
        ...
        if 'text' in tweet:
            if 'media' in tweet['entities'] and tweet['coordinates']:
                json_feature = {
...
# Save geo data
with open('coords_media_2.json', 'w') as fout: #again, saved this separately
